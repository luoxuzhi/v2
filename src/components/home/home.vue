<template>
  <div class="home">
    ...
    <base-input @focus="handleFocus" label="inputTest" v-model="inputValue">
    </base-input>

    <render-func-comp v-show="show"></render-func-comp>
    <el-button size="mini" @click="handleClick"
      >click to set computed value</el-button
    >
    <el-button size="mini" @click="useAxios">click to use axios</el-button>
    <p>{{ fullName }}</p>
  </div>
</template>
